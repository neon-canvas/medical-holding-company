...
class WpeCommon extends WpePlugin_common {
	...
	if( $this->is_whitelabel() )
		...
		$wp_admin_bar->add_menu( array( 'id'	=> 'wpengine_adminbar_status','parent' => 'wpengine_adminbar', 'title'  => 'Status Blog', 'href'   => 'http://wpenginestatus.com' ) );
